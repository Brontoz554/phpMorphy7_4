...
class Morphy
{
     ...
     * @var phpMorphy
     */
    private phpMorphy $en;

    /**
     * @var phpMorphy
     */
    private phpMorphy $ru;
...
die();
echo $morphy->base('судах');
echo '<br>';
echo $morphy->base('суд');
echo '<br>';
echo $morphy->base('строитеьство');
echo '<br>';
echo $morphy->base('строитеьства');
echo '<br>';
echo $morphy->base('три');
echo '<br>';
echo $morphy->base('треть');
echo '<br>';
